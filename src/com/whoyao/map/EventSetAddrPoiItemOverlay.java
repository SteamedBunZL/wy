 ...
 */
public class EventSetAddrPoiItemOverlay extends ItemizedOverlay<OverlayItem> implements OnClickListener {

	private ArrayList<OverlayItem> mOverlayItemList;
	private OverlayItem actItem = null;
	private View popView;
	private TextView poptext;
	private ImageView popBtnRight;
	private ImageView popBtnLeft;
	...
	public EventSetAddrPoiItemOverlay(MapView mapView) {
	...
	public void setPopText(String text){
		OverlayItem item = (OverlayItem) popView.getTag();
		item.setSnippet(text);
	...
	public void showPop(OverlayItem item){
		if(null == popView || null == popParams){
			popView = LayoutInflater.from(AppContext.context).inflate(R.layout.map_popview_event_setaddr, null);
			poptext = (TextView)popView.findViewById(R.id.popview_address_textview);
			popBtnLeft = (ImageView)popView.findViewById(R.id.popview_left_btn);
			popBtnRight = (ImageView)popView.findViewById(R.id.popview_right_btn);
			popBtnLeft.setOnClickListener(this);
			popBtnRight.setOnClickListener(this);
	...
	public void onClick(View v) {
		if(null != popClickListener){
			popClickListener.onClick(v,(OverlayItem) popView.getTag());
		}
	}
}
