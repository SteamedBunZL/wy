 ...
 */
public class VenueOverlay extends ItemizedOverlay<OverlayItem> {
	...
	public VenueOverlay(MapView mapView) {
	...
	public void showPop(OverlayItem item) {
		...
		VenueItemModel venue = mVenueMap.get(item.getSnippet());
		if (null != venue) {
			tvPopTitle.setText(venue.getFullname());
			if (venue.getServicetype().length > 1) {
